...
class AccountViewController: UIViewController {
    ...
    private func addSubViews() {
        [profileLabel,avatarImage,userNameLabel,lineOfView,accountInformationButton,accountInformationImage,privacyPolicyButton,privacyImage,adminButton,exitImage,imageAdminButton,helpFaqButton].forEach {
